...
const images = [
  require('../assets/images/cardCandy.png'),
  require('../assets/images/cardCandy2.png'),
  require('../assets/images/cardCandy3.png'),
  require('../assets/images/cardCandy4.png'),
  require('../assets/images/cardCandy5.png'),
  require('../assets/images/cardCandy6.png'),
  require('../assets/images/cardCandy.png'),
  require('../assets/images/cardCandy2.png'),
  require('../assets/images/cardCandy3.png'),
  require('../assets/images/cardCandy4.png'),
...
const GameCandy = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground
        source={require('../assets/images/candyBg.png')}
        resizeMode="cover"
