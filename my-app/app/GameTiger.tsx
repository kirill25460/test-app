...
const images = [
  require('../assets/images/tigerCard.png'),
 require('../assets/images/tigerCard2.png'),
  require('../assets/images/tigerCard3.png'),
  require('../assets/images/tigerCard4.png'),
  require('../assets/images/tigerCard.png'),
 require('../assets/images/tigerCard2.png'),
  require('../assets/images/tigerCard3.png'),
  require('../assets/images/tigerCard4.png'),
...
const GameTiger = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground
        source={require('../assets/images/tigerBg.png')}
        resizeMode="cover"
