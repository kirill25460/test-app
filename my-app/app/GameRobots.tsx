...
const images = [
  require('../assets/images/robotsCard.png'),
 require('../assets/images/robotsCard2.png'),
 require('../assets/images/robotsCard3.png'),
 require('../assets/images/robotsCard4.png'),
 require('../assets/images/robotsCard5.png'),
 require('../assets/images/robotsCard6.png'),
 require('../assets/images/robotsCard.png'),
 require('../assets/images/robotsCard2.png'),
 require('../assets/images/robotsCard3.png'),
 require('../assets/images/robotsCard4.png'),
...
const GameRobots = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground
        source={require('../assets/images/robotsBg.png')}
        resizeMode="cover"
